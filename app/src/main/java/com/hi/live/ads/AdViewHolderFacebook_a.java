...
import com.hi.live.databinding.ItemNativeadBinding;

import java.util.ArrayList;
import java.util.List;

public class AdViewHolderFacebook_a extends RecyclerView.ViewHolder {
    ItemNativeadBinding binding;
    private Context context;

    public AdViewHolderFacebook_a(@NonNull View itemView) {
        super(itemView);
