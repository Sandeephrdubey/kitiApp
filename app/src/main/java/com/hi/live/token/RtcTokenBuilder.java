...
public class RtcTokenBuilder {
    ...
    public enum Role {
        ...
        Role_Attendee(0),
        /**
         * RECOMMENDED. Use this role for a voice/video call or a android broadcast, if your scenario does not require authentication for [Hosting-in](https://docs.agora.io/en/Agora%20Platform/terms?platform=All%20Platforms#hosting-in).
         */
        Role_Publisher(1),
        /**
