...
import com.hi.live.databinding.ItemReedemMathodBinding;

public class ReedemGatewayAdapter_a extends RecyclerView.Adapter<ReedemGatewayAdapter_a.GatewayViewHolder> {
    ...
    public ReedemGatewayAdapter_a(String[] gateways, OnReedemMathodClickListner onReedemMathodClickListner) {
    ...
    public void onBindViewHolder(@NonNull GatewayViewHolder holder, int position) {
        ...
        if (position == selected) {
            ...
            holder.binding.tvname.setBackground(ContextCompat.getDrawable(context, R.drawable.bg_greadentround_a));
