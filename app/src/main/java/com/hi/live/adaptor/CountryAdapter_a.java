...
import com.hi.live.databinding.ItemCountryBinding;
import com.hi.live.models.CountryRoot;

import java.util.ArrayList;
import java.util.List;

public class CountryAdapter_a extends RecyclerView.Adapter<CountryAdapter_a.CountryViewHolder> {
    ...
    public CountryAdapter_a(String selectedCountryName) {
    ...
    public void onBindViewHolder(@NonNull CountryViewHolder holder, int position) {
        ...
        if (selectedCountryName.equals(country.getName())) {
            holder.binding.lytmain.setBackground(ContextCompat.getDrawable(context, R.drawable.bg_greengredentround_a));
        }
