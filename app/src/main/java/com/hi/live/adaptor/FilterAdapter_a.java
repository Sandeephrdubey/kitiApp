...
public class FilterAdapter_a extends RecyclerView.Adapter<FilterAdapter_a.FilterViewHolder> {
    List<FilterRoot> filters = FilterUtils.filterRoots;
    private Context context;
    private OnFilterClickListnear onFilterClickListnear;

    public FilterAdapter_a(OnFilterClickListnear onFilterClickListnear) {
