...
import com.hi.live.databinding.ItemSearchHistoryBinding;

import java.util.ArrayList;
import java.util.List;

public class SearchHistoryAdapter_a extends RecyclerView.Adapter<SearchHistoryAdapter_a.SearchHistoryViewHolder> {
    Context context;
    List<String> history = new ArrayList<>();
    OnHistoryItemClickListner onHistoryItemClickListner;


    public SearchHistoryAdapter_a(List<String> history, OnHistoryItemClickListner onHistoryItemClickListner) {
