...
import com.hi.live.databinding.ActivityFakeCallBinding;
...
public class FakeCallActivity_a extends BaseActivity_a {
    ...
    private void setCamara() {
        ...
        if (mCamera != null) {
            ...
            mPreview = new CameraPreview(FakeCallActivity_a.this, mCamera);
            binding.cameraPreview.addView(mPreview);
        } else {
            Toast.makeText(FakeCallActivity_a.this, "No Camara Detected!!!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private boolean checkAndRequestPermissions() {
        int camera = ContextCompat.checkSelfPermission(FakeCallActivity_a.this,
                Manifest.permission.CAMERA);
        int wtite = ContextCompat.checkSelfPermission(FakeCallActivity_a.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        int read = ContextCompat.checkSelfPermission(FakeCallActivity_a.this, Manifest.permission.READ_EXTERNAL_STORAGE);
        int audio = ContextCompat.checkSelfPermission(FakeCallActivity_a.this, Manifest.permission.RECORD_AUDIO);
        ...
        if (!listPermissionsNeeded.isEmpty()) {
            ActivityCompat.requestPermissions(FakeCallActivity_a.this, listPermissionsNeeded.toArray(new String[listPermissionsNeeded.size()]), REQUEST_ID_MULTIPLE_PERMISSIONS);
            return false;
        }
        return true;
    }
...
//                        // shouldShowRequestPermissionRationale will return true
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(FakeCallActivity_a.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) || ActivityCompat.shouldShowRequestPermissionRationale(FakeCallActivity_a.this, Manifest.permission.CAMERA) || ActivityCompat.shouldShowRequestPermissionRationale(FakeCallActivity_a.this, Manifest.permission.READ_EXTERNAL_STORAGE) || ActivityCompat.shouldShowRequestPermissionRationale(FakeCallActivity_a.this, Manifest.permission.RECORD_AUDIO)) {
                    ...
                    //shouldShowRequestPermissionRationale will return false
                        ...
                        Toast.makeText(FakeCallActivity_a.this, "Go to settings and enable permissions", Toast.LENGTH_LONG)
                                .show();
                        //                            //proceed with logic by disabling the related features or quit the app.
                    }
                }
    ...
    private void showDialogOK(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(FakeCallActivity_a.this)
                .setMessage(message)
            ...
            public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
                switch (playbackState) {
                    ...
                    case STATE_BUFFERING:
                        ...
                        break;
                    case STATE_ENDED:
                        Toast.makeText(FakeCallActivity_a.this, "Call Ended!", Toast.LENGTH_SHORT).show();
